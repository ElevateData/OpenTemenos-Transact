...
namespace OpenTemenos.Transacts.Party.SecuritiesCustomers
{
    ...
    public partial class SecuritiesCustomerBody 
    {
        ...
        [Newtonsoft.Json.JsonProperty("customerTypes", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
