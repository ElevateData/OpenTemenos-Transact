...
namespace OpenTemenos.Transacts.Meta.DwExportProperties
{
    ...
    public partial class DWExportPropertiesBody 
    {
        ...
        [Newtonsoft.Json.JsonProperty("utilsProperties", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
