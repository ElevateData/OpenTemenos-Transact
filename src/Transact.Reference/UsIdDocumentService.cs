...
namespace OpenTemenos.Transacts.Reference.UsIdDocuments
{
    ...
    public partial class Anonymous 
    {
        ...
        [Newtonsoft.Json.JsonProperty("documentNames", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
