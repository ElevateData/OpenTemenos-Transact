...
namespace OpenTemenos.Transacts.Reference.UsCovenants
{
    ...
    public partial class Anonymous 
    {
        ...
        [Newtonsoft.Json.JsonProperty("covenantPlan", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
