...
namespace OpenTemenos.Transacts.Reference.UsBenOwnerTypes
{
    ...
    public partial class Anonymous 
    {
        ...
        [Newtonsoft.Json.JsonProperty("ownershipCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
