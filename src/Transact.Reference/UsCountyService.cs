...
namespace OpenTemenos.Transacts.Reference.UsCounties
{
    ...
    {
        [Newtonsoft.Json.JsonProperty("countyNames", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
