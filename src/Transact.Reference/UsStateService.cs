...
namespace OpenTemenos.Transacts.Reference.UsStates
{
    ...
    public partial class Anonymous 
    {
        ...
        [Newtonsoft.Json.JsonProperty("stateDescriptions", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
