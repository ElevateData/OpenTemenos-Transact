...
namespace OpenTemenos.Transacts.Reference.ChequeTypes
{
    ...
    public partial class Anonymous 
    {
        ...
        [Newtonsoft.Json.JsonProperty("defaultIssueNumber", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
